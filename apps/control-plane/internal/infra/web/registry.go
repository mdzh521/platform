...
var apiRegistryEntries = []APIRegistryEntry{
	...
	{Domain: "cloud", Method: "GET", Path: "/api/v1/cloud/workbench", Description: "Get foundation delivery workbench", AuthMode: "jwt", Version: "v1"},
	{Domain: "cloud", Method: "GET", Path: "/api/v1/cloud/accounts", Description: "List cloud accounts", AuthMode: "jwt", Version: "v1"},
	{Domain: "cloud", Method: "GET", Path: "/api/v1/cloud/network-plans", Description: "List foundation delivery networks", AuthMode: "jwt", Version: "v1"},
